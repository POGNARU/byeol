...
├─ entries/            # 각 밤하늘 HTML
│  ├─ nightsky_YYYY-MM-DD.html   # 주간 (2026~, 월~일 주, 파일명은 그 주 일요일)
...
첫 적용: `entries/nightsky_2026-07-04.html` (북두칠성). 이후 매주 이어짐 — 최신: `entries/nightsky_2026-07-12.html` (7월 6–12일, 카시오페이아).
